...
CREATE TABLE IF NOT EXISTS public.plf_cgt_itineraires (
  itineraire_id SERIAL PRIMARY KEY,
  nom char(255) NOT NULL,
  SEQ smallint NOT NULL,
  organisme char(100)  NOT NULL,
  localite char(50)  NOT NULL,
  commune char(50)  NOT NULL,
  urlweb char(200)  NOT NULL,
  idreco char(100)  NOT NULL,
  distance decimal(5,1) DEFAULT NULL,
  typecirc char(50)  DEFAULT NULL,
  signaletique char(50)  DEFAULT NULL,
  hdifmin smallint DEFAULT NULL,
  hdifmax smallint DEFAULT NULL,
  gpx_url char(200)  DEFAULT NULL,
  infusgped char(10)  DEFAULT NULL,
  infusgpedpmr char(10)  DEFAULT NULL,
  infusgpedpou char(10)  DEFAULT NULL,
  infusgtrail char(10)  DEFAULT NULL,
  infusgtrailpmr char(10)  DEFAULT NULL,
  infusgtrailpou char(10)  DEFAULT NULL,
  infusgequ char(10)  DEFAULT NULL,
  infusgatt char(10)  DEFAULT NULL,
  infusgvtc char(10)  DEFAULT NULL,
  infusgvtcpmr char(10)  DEFAULT NULL,
  infusgvtt char(10)  DEFAULT NULL,
  infusgvttpmr char(10)  DEFAULT NULL,
  infusgenduro char(10)  DEFAULT NULL,
  infusgfreestyle char(10)  DEFAULT NULL,
  infusggravel char(10)  DEFAULT NULL,
  infusgvelotour char(10)  DEFAULT NULL,
  infusgvelotourpmr char(10)  DEFAULT NULL,
  infusgvtc_a29b char(10)  DEFAULT NULL,
  infusgxc char(10)  DEFAULT NULL,
  infusgauto char(10)  DEFAULT NULL,
  infusgmoto char(10)  DEFAULT NULL,
  infusgnwalk char(10)  DEFAULT NULL,
  infusgski char(10)  DEFAULT NULL,
  infusgskialpin char(10)  DEFAULT NULL,
  UNIQUE (nom,SEQ),
  UNIQUE (itineraire_id),
  UNIQUE (commune),
  UNIQUE (localite)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_cgt_itineraires OWNER TO plf;


-- Dumping structure for table plf.plf_infos
CREATE TABLE IF NOT EXISTS public.plf_infos (
  infos_id SERIAL PRIMARY KEY,
  Infos_Name char(50) NOT NULL,
  Infos_Date char(255) NOT NULL,
  Infos_Value char(50)  NOT NULL,
  UNIQUE (infos_id)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_infos OWNER TO plf;

-- Dumping data for table plf.plf_infos: ~6 rows (approximately)
INSERT INTO public.plf_infos (infos_id, Infos_Name, Infos_Date, Infos_Value) VALUES
...
CREATE TABLE IF NOT EXISTS public.plf_spw_cantonnements (
  cantonnement_id SERIAL PRIMARY KEY,
  CAN smallint NOT NULL,
  PREPOSE char(30) DEFAULT NULL,
  CANTON char(40) DEFAULT NULL,
  TEL_CAN char(14) DEFAULT NULL,
  GEOM geometry(MultiPolygon,31370) NOT NULL,
  UNIQUE (CAN)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_cantonnements OWNER TO plf;
...
CREATE TABLE IF NOT EXISTS public.plf_spw_cantonnements_adresses (
  num_canton SERIAL PRIMARY KEY,
  direction char(50) DEFAULT NULL,
  email char(100) DEFAULT NULL,
  attache char(255) DEFAULT NULL,
  CP char(10) DEFAULT NULL,
  localite char(50) DEFAULT NULL,
  rue char(80) DEFAULT NULL,
...
ALTER TABLE IF EXISTS public.plf_spw_cantonnements_adresses OWNER TO plf;
...
INSERT INTO plf_spw_cantonnements_adresses (num_canton, direction, email, attache, CP, localite, rue, numero, latitude, longitude) VALUES
	...
	(612, 'MONS', 'cantonnement.nature.forets.mons@spw.wallonie.be', 'Jean-François DULIERE ', '7000', 'MONS', 'Rue Achille Legrand', '16', 50.4496732, 3.9458946),
	...
	(713, 'DINANT', 'cantonnement.nature.forets.rochefort@spw.wallonie.be', 'Thibaut GHEYSEN ', '5580', 'ROCHEFORT', 'Rue de la Sauvenière', '16', 50.1597058, 5.2222437),
	...
	(813, 'LIEGE', 'cantonnement.nature.forets.spa@spw.wallonie.be', 'Nicolas DENUIT', '4845', 'JALHAY', 'Balmoral', '41', 50.5089796, 5.892994),
	(821, 'MALMEDY-BULLANGE', 'cantonnement.nature.forets.bullange@spw.wallonie.be', 'Christophe PANKERT ', '4760', 'BÜLLINGEN/BULLANGE', 'Sankt Vither Strasse', '1', 50.40432, 6.2524396),
	...
	(913, 'Arlon', 'cantonnement.nature.forets.virton@spw.wallonie.be', 'David STORMS ', '6760', 'Virton', 'Rue Croix Le Maire', '17', 49.5674538, 5.5295788),
	...
	(931, 'MARCHE EN FAMENNE', 'cantonnement.nature.forets.laroche@spw.wallonie.be', 'Sandrine LAMOTTE', '6980', 'LA ROCHE-EN-ARDENNE', 'Rue du Val du Bronze', '9', 50.18361, 5.57547),
...
CREATE TABLE IF NOT EXISTS public.plf_spw_cc (
  cc_id SERIAL PRIMARY KEY,
  OBJECTID smallint NOT NULL,
  N_AGREMENT smallint NOT NULL,
  DENOMINATION char(300) NOT NULL,
  ABREVIATION char(300) NOT NULL,
  RUE_CC char(200) DEFAULT NULL,
  NUM_CC char(20) DEFAULT NULL,
  CP_CC char(12) DEFAULT NULL,
  LOCALITE_CC char(50) DEFAULT NULL,
  NOM_PSDT char(150) DEFAULT NULL,
  PRENOM_PSDT char(150) DEFAULT NULL,
  NOM_SECR char(150) DEFAULT NULL,
  PRENOM_SECR char(150) DEFAULT NULL,
  SUPERFICIE decimal(8,2) DEFAULT '0.00',
  LIEN_CARTE char(510) DEFAULT NULL,
  GEOM geometry(MultiPolygon,31370),
  UNIQUE (cc_id)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_cc OWNER TO plf;




-- Dumping structure for table plf.plf_spw_cc_adresses
CREATE TABLE IF NOT EXISTS public.plf_spw_cc_adresses (
  cc_adresses_id SERIAL PRIMARY KEY,
  Code char(10) NOT NULL,
  email char(100) DEFAULT NULL,
  site_internet char(255) DEFAULT NULL,
  logo char(20) DEFAULT NULL,
  latitude double precision DEFAULT NULL,
  longitude double precision DEFAULT NULL,
  UNIQUE (Code)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_cc_adresses OWNER TO plf;
...
CREATE TABLE IF NOT EXISTS public.plf_spw_cc_concordance (
  cc_id int DEFAULT NULL,
  nugc int DEFAULT NULL
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_cc_concordance OWNER TO plf;
...
CREATE TABLE IF NOT EXISTS public.plf_spw_chasses (
  chasse_id SERIAL PRIMARY KEY,
  SAISON smallint NOT NULL,
  N_LOT char(10) NOT NULL,
  NUM int NOT NULL,
  MODE_CHASSE char(9) DEFAULT NULL,
  DATE_CHASSE date NOT NULL,
  FERMETURE char(1) DEFAULT NULL,
  KEYG char(50) NOT NULL,
  UNIQUE (KEYG,DATE_CHASSE,NUM),
  UNIQUE (chasse_id)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_chasses OWNER TO plf;


-- Dumping structure for table plf.plf_spw_territoires
CREATE TABLE IF NOT EXISTS public.plf_spw_territoires (
  territoires_id SERIAL PRIMARY KEY,
  OBJECTID int DEFAULT NULL,
  SAISON smallint NOT NULL,
  N_LOT char(10) NOT NULL,
  KEYG char(50) NOT NULL,
  SEQ integer NOT NULL,
  SERVICE char(5) DEFAULT NULL,
  NUGC smallint DEFAULT NULL,
  TITULAIRE_ADH_UGC integer NOT NULL,
  DATE_MAJ date DEFAULT NULL,
  SHAPE geometry(MultiPolygon,31370) NOT NULL,
  UNIQUE (N_LOT,SAISON,SEQ)
) TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.plf_spw_territoires OWNER TO plf;



CREATE OR REPLACE VIEW public.view_spw_cantonnements
 AS
 SELECT 
...
RIGHT OUTER JOIN  plf_spw_cantonnements_adresses on
  plf_spw_cantonnements.CAN = plf_spw_cantonnements_adresses.num_canton;



CREATE OR REPLACE VIEW public.view_spw_cc
 AS
 SELECT  
...
FROM 
  ((public.plf_spw_cc left OUTER join public.plf_spw_cc_adresses on
    (plf_spw_cc_adresses.Code = plf_spw_cc.ABREVIATION)) 
      inner join public.plf_spw_cc_concordance on
        (plf_spw_cc_concordance.cc_id = plf_spw_cc.cc_id));




CREATE OR REPLACE VIEW public.view_spw_chasses
 AS 
 SELECT 
...
from 
  (plf_spw_chasses left outer join plf_spw_territoires on
...
CREATE OR REPLACE VIEW view_spw_territoires 
 AS 
 SELECT 
...
from 
  (((plf_spw_territoires left outer join plf_spw_cantonnements on
    (cast(plf_spw_territoires.SERVICE as varchar) = cast(plf_spw_cantonnements.CAN as varchar)) 
left outer join plf_spw_cantonnements_adresses on
  (cast(plf_spw_cantonnements.CAN as varchar) = cast(plf_spw_cantonnements_adresses.num_canton as varchar)) 
left outer join view_spw_cc on
