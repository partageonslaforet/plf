...
$Url_cleaned = preg_replace("/.*\/API_PG.php/i", "", $requestUri);
...
if ($parts[2] == "SPW" and $parts[3] == "TERRITOIRES" and $parts[4] == "1") {
    ...
    echo json_encode([
        ...
        $database = new Database_PG();
        $database->update_LastRuntime("cron_territoires", $start=true);
        
        $gateway = new SPW_Territoires_Gateway_PG($database);
        $controller = new SPW_Territoires_Controller_PG($gateway);   
